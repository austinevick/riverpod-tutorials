  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          elevation: 0,
          title: CustomText(
              text: 'Doctors', color: AppColors.blue, big: true, bold: true),
                                          ...
                                          if (state.datalist == null) {
                                            return const Center(
                                                child: SizedBox(
                                                    width: 35,
                                                    child:
                                                        CircularProgressIndicator())); //VitalsDatas().Vitals();
                                          } else if (state.datalist!.isEmpty) {
                                            return const Center(); //VitalsDatas().Vitals();
                                          } else {
                                            return Padding(
                                                padding:
                                                                ...
                                                                .map(
                                                                    (e) =>
                                                                        Column(
                                                                          children: [
                                                                            ListTile(
                                                                              title: CustomText(text: e.name, color: Colors.black, big: true, bold: true, maxLines: 2),
