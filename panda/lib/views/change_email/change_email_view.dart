...
class ChangeEmailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var bloc = BlocProvider.of<ChangeEmailBloc>(context);
    bloc.add(InitChangeEmail());
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(
                              child: CustomText(
                                  text:
                                      'Use a verified email address e.g. mail@me.com \n we will send a verification mail to this address',
                                  color: AppColors.blue,
                                  extraSmall: true,
                                  bold: true),
                            ),
