...
class _LoginScreenState extends State<LoginScreen> {
  ...
  String your_redirect_url =
      'https://my-starter-project-bc4e2.firebaseapp.com/';
  ...
  void loginWithFacebook() async {
    ...
    // if (result != null) {
    //   try {
    //     final facebookAuthCred = FacebookAuth.i.accessToken;
                      ...
                      Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                    onTap: _handleSignIn, //,loginWithFacebook()
                                    child: const Image(
                                        height: 40,
