                      ...
                      child: Padding(
                          ...
                          child: Column(children: [
                            ...
                            ListTile(
                              ...
                              title: CustomText(
                                  text:
                                      '${_data.userInfo!.firstName} ${_data.userInfo!.lastName}',
                                  color: Colors.black,
                                  big: true,
                                  bold: true),
                              subtitle: CustomText(
                                text:
                                    '${_data.titles} - ${_data.specialty!.field}',
                                color: Colors.grey,
                                bold: true,
                                extraSmall: true,
                              ),
                                  ...
                                  Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          CustomText(
                                            text:
                                                '${formattedDate(date)} $time.00${amPm(int.parse(time))}',
                                            color: AppColors.blue,
                                            bold: true,
                                            small: true,
                                          ),
                            ...
                            CustomButton(
                                ...
                                onPress: () {
                                  _bloc.add(CreateEvent(data, context));
                                }),
                            const SizedBox(height: 20),
                            Row(
