...
class BookingCompleteBloc
    extends Bloc<BookingCompleteEvent, BookingCompleteState> {
  BookingCompleteBloc(super.initialState);

  @override
  void onTransition(
      Transition<BookingCompleteEvent, BookingCompleteState> transition) {
    print(transition);
    super.onTransition(transition);
  }

  Stream<BookingCompleteState> mapEventToState(
      BookingCompleteEvent event) async* {
