  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title:
            CustomText(text: 'Set Touch ID', color: AppColors.blue, bold: true),
        ...
        child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                CustomText(
                    text: 'Login faster, set up',
                    color: AppColors.green,
                    bold: true),
                CustomText(
                    text: 'Touch ID', color: AppColors.green, bold: true),
                    ...
                    onPress: () {
                      if (_canCheckBiometrics == true) {
                        ...
                        if (_availableBiometrics!.isNotEmpty) {
                          print(
                              'available length: ${_availableBiometrics!.length}');
                          _authenticate;
                        } else {
