...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  late String firstName, lastName, gender, dateOfBirth;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            child: Padding(
                padding:
                    EdgeInsets.only(top: statusBarHeight, left: 15, right: 15),
                child: Column(
                    ...
                    children: [
                      ...
                      CustomText(
                        text:
                            'Password should at least be 8 characters in length and  contain,',
                        color: AppColors.blue,
                        extraSmall: true,
                      ),
                      CustomText(
                        text:
                            'at least one uppercase letter, lowercase letter, one number',
                        color: AppColors.blue,
                        extraSmall: true,
                      ),
                      CustomText(
                        text: 'and one special character',
                        color: AppColors.blue,
                        extraSmall: true,
                      ),
                      const SizedBox(height: 15.0),
                      ...
                      CustomText(
                          text:
                              'By clicking Join Now or Sign Up with Google or',
                          color: AppColors.blue,
                          extraSmall: true,
                          bold: true),
                      Row(
                        ...
                        children: <Widget>[
                          CustomText(
                              text: 'Facebook you agree to Panda Health\'s ',
                              color: AppColors.blue,
                              extraSmall: true,
                              bold: true),
                          const CustomText(
                      ...
                      CustomButton(
                          label: 'JOIN NOW',
                          key: const Key('joinNow'),
                          onPress: () {
                            _bloc.add(const CheckForm(true));
