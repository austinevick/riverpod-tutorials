...
class MyVitalsState extends Equatable {
  ...
  const MyVitalsState(
      {this.vitalList, this.controller, this.vitalOptions, this.context});

  MyVitalsState copyWith(
      {List<VitalRow>? vitalList = const [],
      context,
      List<VitalData>? vitalOptions = const [],
  ...
  List<Object> get props =>
      [vitalList!, vitalOptions!, controller!, context!]; //MyVitals
