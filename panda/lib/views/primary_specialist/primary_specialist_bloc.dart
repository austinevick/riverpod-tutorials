...
class PrimarySpecialistBloc
    extends Bloc<PrimarySpecialistEvent, PrimarySpecialistState> {
  PrimarySpecialistBloc(super.initialState);

  @override
  void onTransition(
      Transition<PrimarySpecialistEvent, PrimarySpecialistState> transition) {
    print(transition);
    super.onTransition(transition);
  }

  Stream<PrimarySpecialistState> mapEventToState(
      PrimarySpecialistEvent event) async* {
