...
class _DashboardViewState extends State<DashboardView> {
  ...
  Widget bottomIcon(icon, text, colour) {
    return Column(
      children: [
        IconButton(icon: const Icon(FontAwesomeIcons.home), onPressed: () {})
      ],
    );
  }
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: const BorderRadius.vertical(
                      bottom: const Radius.circular(45.0)),
                ),
                child: Column(
                    ...
                    children: [
                                      ...
                                      children: [
                                        ...
                                        Wrap(
                                          children: [
                                            CustomText(
                                                text:
                                                    'Your target for today is to keep a \npositive mindset and smile.',
                      ...
                      BlocBuilder<DashboardBloc, DashboardState>(
                          buildWhen: (previous, current) =>
                              previous.vitals != current.vitals,
                          builder: (context, state) {
                            if (state.vitals == null) {
                              ...
                              return Center(
                                ...
                                onTap: () => _bloc.add(InitDashboard(context)),
                                child: CustomText(
                                  text: '  Reload ',
                                  color: AppColors.blue,
                                  bold: true,
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        CustomText(
                                                                          text:
                                                                              '${state.vitals![i].value} ${state.vitals![i].unit}',
                                                                          color:
                                                                              AppColors.blue,
                                                                          bold:
                                                                              true,
                      ...
                      children: [
                        ...
                        Card(
                            ...
                            child: ListTile(
                              leading: const Image(
                                height: 40,
                                image: AssetImage('images/blood-pressure.png'),
                                color: Colors.orange,
                                fit: BoxFit.fill,
                              ),
                              title: BlocBuilder<DashboardBloc, DashboardState>(
                                ...
                                builder: (context, state) {
                                  ...
                                  if (state.vitals == null) {
                                    ...
                                    print(state.vitals!.length);
                                    for (var i = 0;
                                        i < state.vitals!.length;
                                        i++) {
                                      if (state.vitals![i].key ==
                                          'bloodPressure') {
                                        bloodPressure =
                                            state.vitals![i].value.toString();
                                      }
                                    }
                                    return CustomText(
                                      text: '$bloodPressure mmHg',
