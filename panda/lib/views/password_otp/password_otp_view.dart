...
class PasswordOtpScreen extends StatelessWidget {
  PasswordOtpScreen({Key? key}) : super(key: key);
        ...
        child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                CustomText(
                    text: 'Please enter 6-digit recovery pin',
                    color: AppColors.blue,
                    bold: true,
                    small: true),
                const SizedBox(height: 20),
                Container(
                  ...
                  child: const Image(
                      fit: BoxFit.fitHeight,
                      image: AssetImage('images/phone-locked.png')),
                ),
                ...
                Row(
                    ...
                    children: <Widget>[
                      CustomText(
                          ...
                          bold: true),
                      CustomText(
                          key: const Key('resendPasswordOtp'),
                          text: '  Resend  ',
                          color: AppColors.blue,
                          bold: true),
                    ]),
