...
class VitalsBloc extends Bloc<VitalsEvent, VitalsState> {
  ...
  Stream<VitalsState> mapEventToState(VitalsEvent event) async* {
    if (event is InitVitals) {
      ...
      if (data.status == 200) {
        ...
        if (_user!.vitals!.temperature != null) {
          _data.add(UserVital(
              'Temperature',
              'temperature',
              _user.vitals!.temperature!.value,
              _user.vitals!.temperature!.unit,
              _user.vitals!.temperature!.numberOfRecords,
              _user.vitals!.temperature!.latestRecord,
              '',
              ''));
        } else {
          _data.add(UserVital(
        ...
        if (_user.vitals!.bloodPressure != null) {
          _data.add(UserVital(
              'Blood Pressure',
              'bloodPressure',
              _user.vitals!.bloodPressure!.systolic,
              _user.vitals!.bloodPressure!.unit,
              _user.vitals!.bloodPressure!.numberOfRecords,
              _user.vitals!.bloodPressure!.latestRecord,
              '',
              ''));
        } else {
          _data.add(UserVital(
              'Blood Pressure', 'bloodPressure', '--', 'kPa', '', '', '', ''));
        }
        if (_user.vitals!.height != null) {
          _data.add(UserVital(
              'Height',
              'height',
              _user.vitals!.height!.value,
              _user.vitals!.height!.unit,
              _user.vitals!.height!.numberOfRecords,
              _user.vitals!.height!.latestRecord,
              '',
              ''));
        } else {
        ...
        if (_user.vitals!.weight != null) {
          _data.add(UserVital(
              'Weight',
              'weight',
              _user.vitals!.weight!.value,
              _user.vitals!.weight!.unit,
              _user.vitals!.weight!.numberOfRecords,
              _user.vitals!.weight!.latestRecord,
              '',
              ''));
        } else {
        ...
        if (_user.vitals!.bmi != null) {
          _data.add(UserVital(
              'Body Mass Index (BMI)',
              'bmi',
              _user.vitals!.bmi!.value,
              _user.vitals!.bmi!.unit,
              _user.vitals!.bmi!.numberOfRecords,
              _user.vitals!.bmi!.latestRecord,
              '',
              ''));
        } else {
          _data.add(UserVital(
        ...
        if (_user.vitals!.oxygenSaturation != null) {
          _data.add(UserVital(
              'Oxygen Saturation',
              'oxygenSaturation',
              _user.vitals!.oxygenSaturation!.value,
              _user.vitals!.oxygenSaturation!.unit,
              _user.vitals!.oxygenSaturation!.numberOfRecords,
              _user.vitals!.oxygenSaturation!.latestRecord,
              '',
              ''));
        } else {
        ...
        if (_user.vitals!.respirationRate != null) {
          _data.add(UserVital(
              'Respiration Rate',
              'respirationRate',
              _user.vitals!.respirationRate!.value,
              _user.vitals!.respirationRate!.unit,
              _user.vitals!.respirationRate!.numberOfRecords,
              _user.vitals!.respirationRate!.latestRecord,
              '',
              ''));
        } else {
          _data.add(UserVital('Respiration Rate', 'respirationRate', '--',
              'breaths/min', '', '', '', ''));
        }
        if (_user.vitals!.heartRate != null) {
          _data.add(UserVital(
              'Heart Rate',
              'heartRate',
              _user.vitals!.heartRate!.value,
              _user.vitals!.heartRate!.unit,
              _user.vitals!.heartRate!.numberOfRecords,
              _user.vitals!.heartRate!.latestRecord,
              '',
              ''));
        } else {
          _data.add(UserVital(
        ...
        if (_user.vitals!.bsa != null) {
          _data.add(UserVital(
              'Body Surface Area',
              'bsa',
              _user.vitals!.bsa!.value!,
              _user.vitals!.bsa!.unit,
              _user.vitals!.bsa!.numberOfRecords,
              _user.vitals!.bsa!.latestRecord,
              '',
              ''));
        } else {
          _data.add(UserVital(
        ...
        yield state.copyWith(vitalList: _vitalList, vitals: _data, user: _user);
        if (_data.isEmpty) {
      ...
      yield state.copyWith(vitalOptions: data.data!);
      ...
      if (data.data!.isEmpty) {
        ...
        Navigator.pushNamed(event.context, VitalHistoryViewRoute,
            arguments: data.data);
      }
    }
  }
