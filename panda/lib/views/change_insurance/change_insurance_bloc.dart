...
class ChangeInsuranceBloc
    extends Bloc<ChangeInsuranceEvent, ChangeInsuranceState> {
  ChangeInsuranceBloc(super.initialState);
  @override
  void onTransition(
      Transition<ChangeInsuranceEvent, ChangeInsuranceState> transition) {
    print(transition);
    super.onTransition(transition);
  }

  Stream<ChangeInsuranceState> mapEventToState(
      ChangeInsuranceEvent event) async* {
