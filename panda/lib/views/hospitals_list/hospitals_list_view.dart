...
class HospitalsListView extends StatelessWidget {
  HospitalsListView({Key? key, required this.hospitalType}) : super(key: key);

  final String hospitalType;

  late HospitalsListBloc _bloc;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          elevation: 0,
          title: CustomText(
              text: hospitalType, color: AppColors.blue, big: true, bold: true),
        ...
        floatingActionButton: FloatingActionButton(
            ...
            child: const Image(
                height: 25, image: AssetImage('images/filter.png'))),
