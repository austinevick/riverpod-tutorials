...
import '../models/add_lab_result_response.dart';
        ...
        child: Padding(
          ...
          child: ListTile(
            leading: Image(
                height: 30,
                color: Colors.orange,
                image: AssetImage(icon(labTest.labName!))),
            title: Row(children: [
              CustomText(
                text: '${labTest.labDefaultValue}${labTest.unit}',
                color: AppColors.blue,
                bold: true,
              ),
              Spacer(),
              CustomText(
                text: '${data.labTests!.length} Records',
                color: AppColors.blue,
                bold: true,
              )
            ]),
            ...
            onTap: () => Navigator.pushNamed(context, LabDetailViewRoute,
                arguments: data),
          ),
        ));
  }
