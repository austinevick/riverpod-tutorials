...
class VitalsData {
  ...
  VitalsData(
      String name, String icon, String unit, int count, this.color, this.data);
}
...
class UserVital {
  ...
  UserVital(name, key, this.value, unit, number_of_records, latest_record,
      blood_pressure, history) {
    icon = icons(key);
    color = HexColor('#338BFD');
...
class VitalsDatas {
  List<VitalsData> dashboardData() {
    List<VitalsData> dashboardMenu = []
      ..add(VitalsData('Heart Rate', 'images/heart.png', 'bpm', 0,
          HexColor('#338BFD'), null))
      ..add(VitalsData('Oxygen Saturation', 'images/o2.png', '%', 0,
          HexColor('#FEB944'), null))
      ..add(VitalsData(
          'Weight', 'images/kg.png', 'kg', 0, HexColor('#338BFD'), null))
      ..add(VitalsData('Respiration Rate', 'images/lungs.png', 'Breadths/min',
          0, HexColor('#FEB944'), null))
      ..add(VitalsData('Height', 'images/body-weight.png', 'cm', 0,
          HexColor('#338BFD'), null))
      ..add(VitalsData('Blood Pressure', 'images/blood-pressure.png', 'mmHg', 0,
          HexColor('#FEB944'), null))
      ..add(VitalsData('Body Temperature', 'images/thermometer.png', 'Celcius',
          0, HexColor('#FEB944'), null))
      ..add(VitalsData('Body Surface Area', 'images/thermometer.png', 'm2', 0,
          HexColor('#FEB944'), null))
      ..add(VitalsData('Body Mass Index', 'images/body-weight.png', 'kg/m2', 0,
          HexColor('#FF6074'), null));
