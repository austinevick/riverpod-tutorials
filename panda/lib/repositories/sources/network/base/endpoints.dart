...
class _User {
  ...
  final forgotPassword =
      '${BASE_URL.baseProduction}/user/pasword/forgotpassword'; //email or otp
  final forgotPasswordEmail =
      '${BASE_URL.baseProduction}/user/pasword/verify/email';
  final forgotPasswordOtp =
      '${BASE_URL.baseProduction}/user/pasword/verify/otp';
  final passwordVerifyOtp = '${BASE_URL.baseProduction}/user/pasword/check/otp';
  final updateAdditionalInfo =
      '${BASE_URL.baseProduction}/user/update/additionalinfo';
